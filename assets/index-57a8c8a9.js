 ...
 */var ti=Symbol.for("react.element"),rd=Symbol.for("react.portal"),od=Symbol.for("react.fragment"),ld=Symbol.for("react.strict_mode"),ad=Symbol.for("react.profiler"),ud=Symbol.for("react.provider"),sd=Symbol.for("react.context"),cd=Symbol.for("react.forward_ref"),dd=Symbol.for("react.suspense"),fd=Symbol.for("react.memo"),pd=Symbol.for("react.lazy"),ua=Symbol.iterator;function hd(e){return e===null||typeof e!="object"?null:(e=ua&&e[ua]||e["@@iterator"],typeof e=="function"?e:null)}var ju={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Nu=Object.assign,_u={};function dt(e,n,t){this.props=e,this.context=n,this.refs=_u,this.updater=t||ju}dt.prototype.isReactComponent={};dt.prototype.setState=function(e,n){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,n,"setState")};dt.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Ru(){}Ru.prototype=dt.prototype;function ul(e,n,t){this.props=e,this.context=n,this.refs=_u,this.updater=t||ju}var sl=ul.prototype=new Ru;sl.constructor=ul;Nu(sl,dt.prototype);sl.isPureReactComponent=!0;var sa=Array.isArray,Lu=Object.prototype.hasOwnProperty,cl={current:null},Au={key:!0,ref:!0,__self:!0,__source:!0};function Du(e,n,t){var i,r={},o=null,l=null;if(n!=null)for(i in n.ref!==void 0&&(l=n.ref),n.key!==void 0&&(o=""+n.key),n)Lu.call(n,i)&&!Au.hasOwnProperty(i)&&(r[i]=n[i]);var a=arguments.length-2;if(a===1)r.children=t;else if(1<a){for(var u=Array(a),s=0;s<a;s++)u[s]=arguments[s+2];r.children=u}if(e&&e.defaultProps)for(i in a=e.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:ti,type:e,key:o,ref:l,props:r,_owner:cl.current}}function md(e,n){return{$$typeof:ti,type:e.type,key:n,ref:e.ref,props:e.props,_owner:e._owner}}function dl(e){return typeof e=="object"&&e!==null&&e.$$typeof===ti}function vd(e){var n={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(t){return n[t]})}var ca=/\/+/g;function Fr(e,n){return typeof e=="object"&&e!==null&&e.key!=null?vd(""+e.key):n.toString(36)}function _i(e,n,t,i,r){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var l=!1;if(e===null)l=!0;else switch(o){case"string":case"number":l=!0;break;case"object":switch(e.$$typeof){case ti:case rd:l=!0}}if(l)return l=e,r=r(l),e=i===""?"."+Fr(l,0):i,sa(r)?(t="",e!=null&&(t=e.replace(ca,"$&/")+"/"),_i(r,n,t,"",function(s){return s})):r!=null&&(dl(r)&&(r=md(r,t+(!r.key||l&&l.key===r.key?"":(""+r.key).replace(ca,"$&/")+"/")+e)),n.push(r)),1;if(l=0,i=i===""?".":i+":",sa(e))for(var a=0;a<e.length;a++){o=e[a];var u=i+Fr(o,a);l+=_i(o,n,t,u,r)}else if(u=hd(e),typeof u=="function")for(e=u.call(e),a=0;!(o=e.next()).done;)o=o.value,u=i+Fr(o,a++),l+=_i(o,n,t,u,r);else if(o==="object")throw n=String(e),Error("Objects are not valid as a React child (found: "+(n==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":n)+"). If you meant to render a collection of children, use an array instead.");return l}function di(e,n,t){if(e==null)return e;var i=[],r=0;return _i(e,i,"","",function(o){return n.call(t,o,r++)}),i}function wd(e){if(e._status===-1){var n=e._result;n=n(),n.then(function(t){(e._status===0||e._status===-1)&&(e._status=1,e._result=t)},function(t){(e._status===0||e._status===-1)&&(e._status=2,e._result=t)}),e._status===-1&&(e._status=0,e._result=n)}if(e._status===1)return e._result.default;throw e._result}var se={current:null},Ri={transition:null},gd={ReactCurrentDispatcher:se,ReactCurrentBatchConfig:Ri,ReactCurrentOwner:cl};D.Children={map:di,forEach:function(e,n,t){di(e,function(){n.apply(this,arguments)},t)},count:function(e){var n=0;return di(e,function(){n++}),n},toArray:function(e){return di(e,function(n){return n})||[]},only:function(e){if(!dl(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};D.Component=dt;D.Fragment=od;D.Profiler=ad;D.PureComponent=ul;D.StrictMode=ld;D.Suspense=dd;D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=gd;D.cloneElement=function(e,n,t){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var i=Nu({},e.props),r=e.key,o=e.ref,l=e._owner;if(n!=null){if(n.ref!==void 0&&(o=n.ref,l=cl.current),n.key!==void 0&&(r=""+n.key),e.type&&e.type.defaultProps)var a=e.type.defaultProps;for(u in n)Lu.call(n,u)&&!Au.hasOwnProperty(u)&&(i[u]=n[u]===void 0&&a!==void 0?a[u]:n[u])}var u=arguments.length-2;if(u===1)i.children=t;else if(1<u){a=Array(u);for(var s=0;s<u;s++)a[s]=arguments[s+2];i.children=a}return{$$typeof:ti,type:e.type,key:r,ref:o,props:i,_owner:l}};D.createContext=function(e){return e={$$typeof:sd,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:ud,_context:e},e.Consumer=e};D.createElement=Du;D.createFactory=function(e){var n=Du.bind(null,e);return n.type=e,n};D.createRef=function(){return{current:null}};D.forwardRef=function(e){return{$$typeof:cd,render:e}};D.isValidElement=dl;D.lazy=function(e){return{$$typeof:pd,_payload:{_status:-1,_result:e},_init:wd}};D.memo=function(e,n){return{$$typeof:fd,type:e,compare:n===void 0?null:n}};D.startTransition=function(e){var n=Ri.transition;Ri.transition={};try{e()}finally{Ri.transition=n}};D.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};D.useCallback=function(e,n){return se.current.useCallback(e,n)};D.useContext=function(e){return se.current.useContext(e)};D.useDebugValue=function(){};D.useDeferredValue=function(e){return se.current.useDeferredValue(e)};D.useEffect=function(e,n){return se.current.useEffect(e,n)};D.useId=function(){return se.current.useId()};D.useImperativeHandle=function(e,n,t){return se.current.useImperativeHandle(e,n,t)};D.useInsertionEffect=function(e,n){return se.current.useInsertionEffect(e,n)};D.useLayoutEffect=function(e,n){return se.current.useLayoutEffect(e,n)};D.useMemo=function(e,n){return se.current.useMemo(e,n)};D.useReducer=function(e,n,t){return se.current.useReducer(e,n,t)};D.useRef=function(e){return se.current.useRef(e)};D.useState=function(e){return se.current.useState(e)};D.useSyncExternalStore=function(e,n,t){return se.current.useSyncExternalStore(e,n,t)};D.useTransition=function(){return se.current.useTransition()};D.version="18.2.0";Pu.exports=D;var x=Pu.exports;const yd=id(x),kd=td({__proto__:null,default:yd},[x]);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sd=x,Cd=Symbol.for("react.element"),xd=Symbol.for("react.fragment"),Ed=Object.prototype.hasOwnProperty,Pd=Sd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,jd={key:!0,ref:!0,__self:!0,__source:!0};function Tu(e,n,t){var i,r={},o=null,l=null;t!==void 0&&(o=""+t),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(l=n.ref);for(i in n)Ed.call(n,i)&&!jd.hasOwnProperty(i)&&(r[i]=n[i]);if(e&&e.defaultProps)for(i in n=e.defaultProps,n)r[i]===void 0&&(r[i]=n[i]);return{$$typeof:Cd,type:e,key:o,ref:l,props:r,_owner:Pd.current}}mr.Fragment=xd;mr.jsx=Tu;mr.jsxs=Tu;Eu.exports=mr;var f=Eu.exports,po={},zu={exports:{}},ke={},Mu={exports:{}},Ou={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(P,L){var A=P.length;P.push(L);e:for(;0<A;){var Q=A-1>>>1,Z=P[Q];if(0<r(Z,L))P[Q]=L,P[A]=Z,A=Q;else break e}}function t(P){return P.length===0?null:P[0]}function i(P){if(P.length===0)return null;var L=P[0],A=P.pop();if(A!==L){P[0]=A;e:for(var Q=0,Z=P.length,si=Z>>>1;Q<si;){var kn=2*(Q+1)-1,Ir=P[kn],Sn=kn+1,ci=P[Sn];if(0>r(Ir,A))Sn<Z&&0>r(ci,Ir)?(P[Q]=ci,P[Sn]=A,Q=Sn):(P[Q]=Ir,P[kn]=A,Q=kn);else if(Sn<Z&&0>r(ci,A))P[Q]=ci,P[Sn]=A,Q=Sn;else break e}}return L}function r(P,L){var A=P.sortIndex-L.sortIndex;return A!==0?A:P.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],s=[],h=1,m=null,v=3,y=!1,k=!1,g=!1,_=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(P){for(var L=t(s);L!==null;){if(L.callback===null)i(s);else if(L.startTime<=P)i(s),L.sortIndex=L.expirationTime,n(u,L);else break;L=t(s)}}function w(P){if(g=!1,p(P),!k)if(t(u)!==null)k=!0,Mr(C);else{var L=t(s);L!==null&&Or(w,L.startTime-P)}}function C(P,L){k=!1,g&&(g=!1,d(R),R=-1),y=!0;var A=v;try{for(p(L),m=t(u);m!==null&&(!(m.expirationTime>L)||P&&!_e());){var Q=m.callback;if(typeof Q=="function"){m.callback=null,v=m.priorityLevel;var Z=Q(m.expirationTime<=L);L=e.unstable_now(),typeof Z=="function"?m.callback=Z:m===t(u)&&i(u),p(L)}else i(u);m=t(u)}if(m!==null)var si=!0;else{var kn=t(s);kn!==null&&Or(w,kn.startTime-L),si=!1}return si}finally{m=null,v=A,y=!1}}var j=!1,N=null,R=-1,$=5,T=-1;function _e(){return!(e.unstable_now()-T<$)}function mt(){if(N!==null){var P=e.unstable_now();T=P;var L=!0;try{L=N(!0,P)}finally{L?vt():(j=!1,N=null)}}else j=!1}var vt;if(typeof c=="function")vt=function(){c(mt)};else if(typeof MessageChannel<"u"){var aa=new MessageChannel,nd=aa.port2;aa.port1.onmessage=mt,vt=function(){nd.postMessage(null)}}else vt=function(){_(mt,0)};function Mr(P){N=P,j||(j=!0,vt())}function Or(P,L){R=_(function(){P(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){k||y||(k=!0,Mr(C))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(P){switch(v){case 1:case 2:case 3:var L=3;break;default:L=v}var A=v;v=L;try{return P()}finally{v=A}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,L){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var A=v;v=P;try{return L()}finally{v=A}},e.unstable_scheduleCallback=function(P,L,A){var Q=e.unstable_now();switch(typeof A=="object"&&A!==null?(A=A.delay,A=typeof A=="number"&&0<A?Q+A:Q):A=Q,P){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=A+Z,P={id:h++,callback:L,priorityLevel:P,startTime:A,expirationTime:Z,sortIndex:-1},A>Q?(P.sortIndex=A,n(s,P),t(u)===null&&P===t(s)&&(g?(d(R),R=-1):g=!0,Or(w,A-Q))):(P.sortIndex=Z,n(u,P),k||y||(k=!0,Mr(C))),P},e.unstable_shouldYield=_e,e.unstable_wrapCallback=function(P){var L=v;return function(){var A=v;v=L;try{return P.apply(this,arguments)}finally{v=A}}}})(Ou);Mu.exports=Ou;var Nd=Mu.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function ni(){return ni=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},ni.apply(this,arguments)}var on;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(on||(on={}));const wu="popstate";function Dp(e){e===void 0&&(e={});function n(i,r){let{pathname:o,search:l,hash:a}=i.location;return ll("",{pathname:o,search:l,hash:a},r.state&&r.state.usr||null,r.state&&r.state.key||"default")}function t(i,r){return typeof r=="string"?r:dr(r)}return zp(n,t,null,e)}function Y(e,n){if(e===!1||e===null||typeof e>"u")throw new Error(n)}function ta(e,n){if(!e){typeof console<"u"&&console.warn(n);try{throw new Error(n)}catch{}}}function Tp(){return Math.random().toString(36).substr(2,8)}function gu(e,n){return{usr:e.state,key:e.key,idx:n}}function ll(e,n,t,i){return t===void 0&&(t=null),ni({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof n=="string"?ht(n):n,{state:t,key:n&&n.key||i||Tp()})}function dr(e){let{pathname:n="/",search:t="",hash:i=""}=e;return t&&t!=="?"&&(n+=t.charAt(0)==="?"?t:"?"+t),i&&i!=="#"&&(n+=i.charAt(0)==="#"?i:"#"+i),n}function ht(e){let n={};if(e){let t=e.indexOf("#");t>=0&&(n.hash=e.substr(t),e=e.substr(0,t));let i=e.indexOf("?");i>=0&&(n.search=e.substr(i),e=e.substr(0,i)),e&&(n.pathname=e)}return n}function zp(e,n,t,i){i===void 0&&(i={});let{window:r=document.defaultView,v5Compat:o=!1}=i,l=r.history,a=on.Pop,u=null,s=h();s==null&&(s=0,l.replaceState(ni({},l.state,{idx:s}),""));function h(){return(l.state||{idx:null}).idx}function m(){a=on.Pop;let _=h(),d=_==null?null:_-s;s=_,u&&u({action:a,location:g.location,delta:d})}function v(_,d){a=on.Push;let c=ll(g.location,_,d);t&&t(c,_),s=h()+1;let p=gu(c,s),w=g.createHref(c);try{l.pushState(p,"",w)}catch(C){if(C instanceof DOMException&&C.name==="DataCloneError")throw C;r.location.assign(w)}o&&u&&u({action:a,location:g.location,delta:1})}function y(_,d){a=on.Replace;let c=ll(g.location,_,d);t&&t(c,_),s=h();let p=gu(c,s),w=g.createHref(c);l.replaceState(p,"",w),o&&u&&u({action:a,location:g.location,delta:0})}function k(_){let d=r.location.origin!=="null"?r.location.origin:r.location.href,c=typeof _=="string"?_:dr(_);return Y(d,"No window.location.(origin|href) available to create URL for href: "+c),new URL(c,d)}let g={get action(){return a},get location(){return e(r,l)},listen(_){if(u)throw new Error("A history only accepts one active listener");return r.addEventListener(wu,m),u=_,()=>{r.removeEventListener(wu,m),u=null}},createHref(_){return n(r,_)},createURL:k,encodeLocation(_){let d=k(_);return{pathname:d.pathname,search:d.search,hash:d.hash}},push:v,replace:y,go(_){return l.go(_)}};return g}var yu;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(yu||(yu={}));function Mp(e,n,t){t===void 0&&(t="/");let i=typeof n=="string"?ht(n):n,r=ia(i.pathname||"/",t);if(r==null)return null;let o=Ic(e);Op(o);let l=null;for(let a=0;l==null&&a<o.length;++a)l=Qp(o[a],Yp(r));return l}function Ic(e,n,t,i){n===void 0&&(n=[]),t===void 0&&(t=[]),i===void 0&&(i="");let r=(o,l,a)=>{let u={relativePath:a===void 0?o.path||"":a,caseSensitive:o.caseSensitive===!0,childrenIndex:l,route:o};u.relativePath.startsWith("/")&&(Y(u.relativePath.startsWith(i),'Absolute route path "'+u.relativePath+'" nested under path '+('"'+i+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),u.relativePath=u.relativePath.slice(i.length));let s=hn([i,u.relativePath]),h=t.concat(u);o.children&&o.children.length>0&&(Y(o.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+s+'".')),Ic(o.children,n,h,s)),!(o.path==null&&!o.index)&&n.push({path:s,score:Hp(s,o.index),routesMeta:h})};return e.forEach((o,l)=>{var a;if(o.path===""||!((a=o.path)!=null&&a.includes("?")))r(o,l);else for(let u of Fc(o.path))r(o,l,u)}),n}function Fc(e){let n=e.split("/");if(n.length===0)return[];let[t,...i]=n,r=t.endsWith("?"),o=t.replace(/\?$/,"");if(i.length===0)return r?[o,""]:[o];let l=Fc(i.join("/")),a=[];return a.push(...l.map(u=>u===""?o:[o,u].join("/"))),r&&a.push(...l),a.map(u=>e.startsWith("/")&&u===""?"/":u)}function Op(e){e.sort((n,t)=>n.score!==t.score?t.score-n.score:$p(n.routesMeta.map(i=>i.childrenIndex),t.routesMeta.map(i=>i.childrenIndex)))}const Ip=/^:\w+$/,Fp=3,Bp=2,Up=1,Wp=10,Vp=-2,ku=e=>e==="*";function Hp(e,n){let t=e.split("/"),i=t.length;return t.some(ku)&&(i+=Vp),n&&(i+=Bp),t.filter(r=>!ku(r)).reduce((r,o)=>r+(Ip.test(o)?Fp:o===""?Up:Wp),i)}function $p(e,n){return e.length===n.length&&e.slice(0,-1).every((i,r)=>i===n[r])?e[e.length-1]-n[n.length-1]:0}function Qp(e,n){let{routesMeta:t}=e,i={},r="/",o=[];for(let l=0;l<t.length;++l){let a=t[l],u=l===t.length-1,s=r==="/"?n:n.slice(r.length)||"/",h=Gp({path:a.relativePath,caseSensitive:a.caseSensitive,end:u},s);if(!h)return null;Object.assign(i,h.params);let m=a.route;o.push({params:i,pathname:hn([r,h.pathname]),pathnameBase:qp(hn([r,h.pathnameBase])),route:m}),h.pathnameBase!=="/"&&(r=hn([r,h.pathnameBase]))}return o}function Gp(e,n){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[t,i]=Kp(e.path,e.caseSensitive,e.end),r=n.match(t);if(!r)return null;let o=r[0],l=o.replace(/(.)\/+$/,"$1"),a=r.slice(1);return{params:i.reduce((s,h,m)=>{if(h==="*"){let v=a[m]||"";l=o.slice(0,o.length-v.length).replace(/(.)\/+$/,"$1")}return s[h]=Xp(a[m]||"",h),s},{}),pathname:o,pathnameBase:l,pattern:e}}function Kp(e,n,t){n===void 0&&(n=!1),t===void 0&&(t=!0),ta(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let i=[],r="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^$?{}|()[\]]/g,"\\$&").replace(/\/:(\w+)/g,(l,a)=>(i.push(a),"/([^\\/]+)"));return e.endsWith("*")?(i.push("*"),r+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):t?r+="\\/*$":e!==""&&e!=="/"&&(r+="(?:(?=\\/|$))"),[new RegExp(r,n?void 0:"i"),i]}function Yp(e){try{return decodeURI(e)}catch(n){return ta(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+n+").")),e}}function Xp(e,n){try{return decodeURIComponent(e)}catch(t){return ta(!1,'The value for the URL param "'+n+'" will not be decoded because'+(' the string "'+e+'" is a malformed URL segment. This is probably')+(" due to a bad percent encoding ("+t+").")),e}}function ia(e,n){if(n==="/")return e;if(!e.toLowerCase().startsWith(n.toLowerCase()))return null;let t=n.endsWith("/")?n.length-1:n.length,i=e.charAt(t);return i&&i!=="/"?null:e.slice(t)||"/"}function Jp(e,n){n===void 0&&(n="/");let{pathname:t,search:i="",hash:r=""}=typeof e=="string"?ht(e):e;return{pathname:t?t.startsWith("/")?t:Zp(t,n):n,search:bp(i),hash:eh(r)}}function Zp(e,n){let t=n.replace(/\/+$/,"").split("/");return e.split("/").forEach(r=>{r===".."?t.length>1&&t.pop():r!=="."&&t.push(r)}),t.length>1?t.join("/"):"/"}function co(e,n,t,i){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+n+"` field ["+JSON.stringify(i)+"].  Please separate it out to the ")+("`to."+t+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Bc(e){return e.filter((n,t)=>t===0||n.route.path&&n.route.path.length>0)}function Uc(e,n,t,i){i===void 0&&(i=!1);let r;typeof e=="string"?r=ht(e):(r=ni({},e),Y(!r.pathname||!r.pathname.includes("?"),co("?","pathname","search",r)),Y(!r.pathname||!r.pathname.includes("#"),co("#","pathname","hash",r)),Y(!r.search||!r.search.includes("#"),co("#","search","hash",r)));let o=e===""||r.pathname==="",l=o?"/":r.pathname,a;if(i||l==null)a=t;else{let m=n.length-1;if(l.startsWith("..")){let v=l.split("/");for(;v[0]==="..";)v.shift(),m-=1;r.pathname=v.join("/")}a=m>=0?n[m]:"/"}let u=Jp(r,a),s=l&&l!=="/"&&l.endsWith("/"),h=(o||l===".")&&t.endsWith("/");return!u.pathname.endsWith("/")&&(s||h)&&(u.pathname+="/"),u}const hn=e=>e.join("/").replace(/\/\/+/g,"/"),qp=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),bp=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,eh=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function nh(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const Wc=["post","put","patch","delete"];new Set(Wc);const th=["get",...Wc];new Set(th);/**
 ...
 *
 * @license MIT
 */function fr(){return fr=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},fr.apply(this,arguments)}const ra=x.createContext(null),Vc=x.createContext(null),In=x.createContext(null),Ar=x.createContext(null),Fn=x.createContext({outlet:null,matches:[],isDataRoute:!1}),Hc=x.createContext(null);function ih(e,n){let{relative:t}=n===void 0?{}:n;ai()||Y(!1);let{basename:i,navigator:r}=x.useContext(In),{hash:o,pathname:l,search:a}=oa(e,{relative:t}),u=l;return i!=="/"&&(u=l==="/"?i:hn([i,l])),r.createHref({pathname:u,search:a,hash:o})}function ai(){return x.useContext(Ar)!=null}function ui(){return ai()||Y(!1),x.useContext(Ar).location}function $c(e){x.useContext(In).static||x.useLayoutEffect(e)}function rh(){let{isDataRoute:e}=x.useContext(Fn);return e?wh():oh()}function oh(){ai()||Y(!1);let e=x.useContext(ra),{basename:n,navigator:t}=x.useContext(In),{matches:i}=x.useContext(Fn),{pathname:r}=ui(),o=JSON.stringify(Bc(i).map(u=>u.pathnameBase)),l=x.useRef(!1);return $c(()=>{l.current=!0}),x.useCallback(function(u,s){if(s===void 0&&(s={}),!l.current)return;if(typeof u=="number"){t.go(u);return}let h=Uc(u,JSON.parse(o),r,s.relative==="path");e==null&&n!=="/"&&(h.pathname=h.pathname==="/"?n:hn([n,h.pathname])),(s.replace?t.replace:t.push)(h,s.state,s)},[n,t,o,r,e])}function oa(e,n){let{relative:t}=n===void 0?{}:n,{matches:i}=x.useContext(Fn),{pathname:r}=ui(),o=JSON.stringify(Bc(i).map(l=>l.pathnameBase));return x.useMemo(()=>Uc(e,JSON.parse(o),r,t==="path"),[e,o,r,t])}function lh(e,n){return ah(e,n)}function ah(e,n,t){ai()||Y(!1);let{navigator:i}=x.useContext(In),{matches:r}=x.useContext(Fn),o=r[r.length-1],l=o?o.params:{};o&&o.pathname;let a=o?o.pathnameBase:"/";o&&o.route;let u=ui(),s;if(n){var h;let g=typeof n=="string"?ht(n):n;a==="/"||(h=g.pathname)!=null&&h.startsWith(a)||Y(!1),s=g}else s=u;let m=s.pathname||"/",v=a==="/"?m:m.slice(a.length)||"/",y=Mp(e,{pathname:v}),k=fh(y&&y.map(g=>Object.assign({},g,{params:Object.assign({},l,g.params),pathname:hn([a,i.encodeLocation?i.encodeLocation(g.pathname).pathname:g.pathname]),pathnameBase:g.pathnameBase==="/"?a:hn([a,i.encodeLocation?i.encodeLocation(g.pathnameBase).pathname:g.pathnameBase])})),r,t);return n&&k?x.createElement(Ar.Provider,{value:{location:fr({pathname:"/",search:"",hash:"",state:null,key:"default"},s),navigationType:on.Pop}},k):k}function uh(){let e=vh(),n=nh(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),t=e instanceof Error?e.stack:null,r={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"},o=null;return x.createElement(x.Fragment,null,x.createElement("h2",null,"Unexpected Application Error!"),x.createElement("h3",{style:{fontStyle:"italic"}},n),t?x.createElement("pre",{style:r},t):null,o)}const sh=x.createElement(uh,null);class ch extends x.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error||t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){console.error("React Router caught the following error during render",n,t)}render(){return this.state.error?x.createElement(Fn.Provider,{value:this.props.routeContext},x.createElement(Hc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function dh(e){let{routeContext:n,match:t,children:i}=e,r=x.useContext(ra);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),x.createElement(Fn.Provider,{value:n},i)}function fh(e,n,t){var i;if(n===void 0&&(n=[]),t===void 0&&(t=null),e==null){var r;if((r=t)!=null&&r.errors)e=t.matches;else return null}let o=e,l=(i=t)==null?void 0:i.errors;if(l!=null){let a=o.findIndex(u=>u.route.id&&(l==null?void 0:l[u.route.id]));a>=0||Y(!1),o=o.slice(0,Math.min(o.length,a+1))}return o.reduceRight((a,u,s)=>{let h=u.route.id?l==null?void 0:l[u.route.id]:null,m=null;t&&(m=u.route.errorElement||sh);let v=n.concat(o.slice(0,s+1)),y=()=>{let k;return h?k=m:u.route.Component?k=x.createElement(u.route.Component,null):u.route.element?k=u.route.element:k=a,x.createElement(dh,{match:u,routeContext:{outlet:a,matches:v,isDataRoute:t!=null},children:k})};return t&&(u.route.ErrorBoundary||u.route.errorElement||s===0)?x.createElement(ch,{location:t.location,revalidation:t.revalidation,component:m,error:h,children:y(),routeContext:{outlet:null,matches:v,isDataRoute:!0}}):y()},null)}var Qc=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Qc||{}),pr=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(pr||{});function ph(e){let n=x.useContext(ra);return n||Y(!1),n}function hh(e){let n=x.useContext(Vc);return n||Y(!1),n}function mh(e){let n=x.useContext(Fn);return n||Y(!1),n}function Gc(e){let n=mh(),t=n.matches[n.matches.length-1];return t.route.id||Y(!1),t.route.id}function vh(){var e;let n=x.useContext(Hc),t=hh(pr.UseRouteError),i=Gc(pr.UseRouteError);return n||((e=t.errors)==null?void 0:e[i])}function wh(){let{router:e}=ph(Qc.UseNavigateStable),n=Gc(pr.UseNavigateStable),t=x.useRef(!1);return $c(()=>{t.current=!0}),x.useCallback(function(r,o){o===void 0&&(o={}),t.current&&(typeof r=="number"?e.navigate(r):e.navigate(r,fr({fromRouteId:n},o)))},[e,n])}function Ui(e){Y(!1)}function gh(e){let{basename:n="/",children:t=null,location:i,navigationType:r=on.Pop,navigator:o,static:l=!1}=e;ai()&&Y(!1);let a=n.replace(/^\/*/,"/"),u=x.useMemo(()=>({basename:a,navigator:o,static:l}),[a,o,l]);typeof i=="string"&&(i=ht(i));let{pathname:s="/",search:h="",hash:m="",state:v=null,key:y="default"}=i,k=x.useMemo(()=>{let g=ia(s,a);return g==null?null:{location:{pathname:g,search:h,hash:m,state:v,key:y},navigationType:r}},[a,s,h,m,v,y,r]);return k==null?null:x.createElement(In.Provider,{value:u},x.createElement(Ar.Provider,{children:t,value:k}))}function yh(e){let{children:n,location:t}=e;return lh(al(n),t)}new Promise(()=>{});function al(e,n){n===void 0&&(n=[]);let t=[];return x.Children.forEach(e,(i,r)=>{if(!x.isValidElement(i))return;let o=[...n,r];if(i.type===x.Fragment){t.push.apply(t,al(i.props.children,o));return}i.type!==Ui&&Y(!1),!i.props.index||!i.props.children||Y(!1);let l={id:i.props.id||o.join("-"),caseSensitive:i.props.caseSensitive,element:i.props.element,Component:i.props.Component,index:i.props.index,path:i.props.path,loader:i.props.loader,action:i.props.action,errorElement:i.props.errorElement,ErrorBoundary:i.props.ErrorBoundary,hasErrorBoundary:i.props.ErrorBoundary!=null||i.props.errorElement!=null,shouldRevalidate:i.props.shouldRevalidate,handle:i.props.handle,lazy:i.props.lazy};i.props.children&&(l.children=al(i.props.children,o)),t.push(l)}),t}/**
 ...
 *
 * @license MIT
 */function hr(){return hr=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},hr.apply(this,arguments)}function Kc(e,n){if(e==null)return{};var t={},i=Object.keys(e),r,o;for(o=0;o<i.length;o++)r=i[o],!(n.indexOf(r)>=0)&&(t[r]=e[r]);return t}function kh(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function Sh(e,n){return e.button===0&&(!n||n==="_self")&&!kh(e)}const Ch=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset"],xh=["aria-current","caseSensitive","className","end","style","to","children"],Eh="startTransition",Su=kd[Eh];function Ph(e){let{basename:n,children:t,future:i,window:r}=e,o=x.useRef();o.current==null&&(o.current=Dp({window:r,v5Compat:!0}));let l=o.current,[a,u]=x.useState({action:l.action,location:l.location}),{v7_startTransition:s}=i||{},h=x.useCallback(m=>{s&&Su?Su(()=>u(m)):u(m)},[u,s]);return x.useLayoutEffect(()=>l.listen(h),[l,h]),x.createElement(gh,{basename:n,children:t,location:a.location,navigationType:a.action,navigator:l})}const jh=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Nh=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,_h=x.forwardRef(function(n,t){let{onClick:i,relative:r,reloadDocument:o,replace:l,state:a,target:u,to:s,preventScrollReset:h}=n,m=Kc(n,Ch),{basename:v}=x.useContext(In),y,k=!1;if(typeof s=="string"&&Nh.test(s)&&(y=s,jh))try{let c=new URL(window.location.href),p=s.startsWith("//")?new URL(c.protocol+s):new URL(s),w=ia(p.pathname,v);p.origin===c.origin&&w!=null?s=w+p.search+p.hash:k=!0}catch{}let g=ih(s,{relative:r}),_=Lh(s,{replace:l,state:a,target:u,preventScrollReset:h,relative:r});function d(c){i&&i(c),c.defaultPrevented||_(c)}return x.createElement("a",hr({},m,{href:y||g,onClick:k||o?i:d,ref:t,target:u}))}),Rh=x.forwardRef(function(n,t){let{"aria-current":i="page",caseSensitive:r=!1,className:o="",end:l=!1,style:a,to:u,children:s}=n,h=Kc(n,xh),m=oa(u,{relative:h.relative}),v=ui(),y=x.useContext(Vc),{navigator:k}=x.useContext(In),g=k.encodeLocation?k.encodeLocation(m).pathname:m.pathname,_=v.pathname,d=y&&y.navigation&&y.navigation.location?y.navigation.location.pathname:null;r||(_=_.toLowerCase(),d=d?d.toLowerCase():null,g=g.toLowerCase());let c=_===g||!l&&_.startsWith(g)&&_.charAt(g.length)==="/",p=d!=null&&(d===g||!l&&d.startsWith(g)&&d.charAt(g.length)==="/"),w=c?i:void 0,C;typeof o=="function"?C=o({isActive:c,isPending:p}):C=[o,c?"active":null,p?"pending":null].filter(Boolean).join(" ");let j=typeof a=="function"?a({isActive:c,isPending:p}):a;return x.createElement(_h,hr({},h,{"aria-current":w,className:C,ref:t,style:j,to:u}),typeof s=="function"?s({isActive:c,isPending:p}):s)});var Cu;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher"})(Cu||(Cu={}));var xu;(function(e){e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(xu||(xu={}));function Lh(e,n){let{target:t,replace:i,state:r,preventScrollReset:o,relative:l}=n===void 0?{}:n,a=rh(),u=ui(),s=oa(e,{relative:l});return x.useCallback(h=>{if(Sh(h,t)){h.preventDefault();let m=i!==void 0?i:dr(u)===dr(s);a(e,{replace:m,state:r,preventScrollReset:o,relative:l})}},[u,a,s,i,r,t,e,o,l])}const Nn=new webkitSpeechRecognition;Nn.continuous=!0;Nn.lang="en-US";Nn.interimResult=!0;const Ah=({word:e,index:n})=>{x.useState(null);const t=r=>{Nn.start();let o=r.toLowerCase();Nn.onresult=l=>{const a=l.results[0][0].transcript;alert(o===a?`Bien, la palabra es: ${a}`:`Mal, dijiste algo como: ${a}`)},setTimeout(()=>{Nn.stop(),setTimeout(()=>{Nn.abort()},500)},4e3)},i=r=>{const o=new SpeechSynthesisUtterance(r);o.rate=.7,o.lang="en-US",speechSynthesis.speak(o)};return f.jsx("div",{className:"word_c",children:f.jsxs("div",{className:"word",children:[f.jsx("span",{className:"word_item",children:e.word}),f.jsxs("div",{className:"pronunciation_container",children:[f.jsx("span",{className:"pronunciation",children:e.pronunciation}),f.jsx("button",{className:"listen",onClick:()=>i(e.word),children:"Listen"})]}),f.jsxs("div",{className:"meaning_word",children:[f.jsx("div",{className:"defi",children:e.definition}),f.jsxs("div",{className:"talk_container",children:[f.jsx("button",{className:"talk",onClick:()=>t(e.word),children:"Talk"}),f.jsx("div",{className:"index",children:n})]})]})]})})},Dh=`the
of
and
to
a
...
put out
put through
put up with`.toLowerCase(),Yc=Dh.split(`
`),Xc=Th.split(`
`),Jc=zh.split(`
`),Zc=Mh.split(`
`),qc=Oh.split(`
