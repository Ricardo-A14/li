 ...
 *
 * @license MIT
 */const eh="startTransition",ca=ld[eh];function nh(e){let{basename:n,children:t,future:r,window:o}=e,l=L.useRef();l.current==null&&(l.current=gp({window:o,v5Compat:!0}));let i=l.current,[u,a]=L.useState({action:i.action,location:i.location}),{v7_startTransition:c}=r||{},p=L.useCallback(m=>{c&&ca?ca(()=>a(m)):a(m)},[a,c]);return L.useLayoutEffect(()=>i.listen(p),[i,p]),L.createElement(qp,{basename:n,children:t,location:u.location,navigationType:u.action,navigator:i})}var da;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher"})(da||(da={}));var fa;(function(e){e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(fa||(fa={}));const Pn=new webkitSpeechRecognition;Pn.continuous=!0;Pn.lang="en-US";Pn.interimResult=!0;const th=({word:e,index:n})=>{L.useState(null);const t=o=>{Pn.start();let l=o.toLowerCase();Pn.onresult=i=>{const u=i.results[0][0].transcript;alert(l===u?`Bien, la palabra es: ${u}`:`Mal, dijiste algo como: ${u}`)},setTimeout(()=>{Pn.stop(),setTimeout(()=>{Pn.abort()},500)},4e3)},r=o=>{const l=new SpeechSynthesisUtterance(o);l.rate=.7,l.lang="en-US",speechSynthesis.speak(l)};return I.jsx("div",{className:"word_c",children:I.jsxs("div",{className:"word",children:[I.jsx("span",{className:"word_item",children:e.word}),I.jsxs("div",{className:"pronunciation_container",children:[I.jsx("span",{className:"pronunciation",children:e.pronunciation}),I.jsx("button",{className:"listen",onClick:()=>r(e.word),children:"Listen"})]}),I.jsxs("div",{className:"meaning_word",children:[I.jsx("div",{className:"defi",children:e.definition}),I.jsx("button",{className:"talk",onClick:()=>t(e.word),children:"Talk"}),I.jsx("div",{className:"index",children:n})]})]})})},rh=`the
of
and
to
a
